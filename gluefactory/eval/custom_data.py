...
# Modified from HPatches
class CustomPipeline(EvalPipeline):
    default_conf = {
        "data_dir": "custom",
        "data": {
            "name": "image_folder",
            "pairs": "custom/list_of_imgs.txt",
            # "pairs": ["custom/20230505_Data_Collection_TM_051_060_100000262599378_20190511_1.jpg", "samuel_jewel.jpg"],
            "preprocessing": {
    ...
    def get_dataloader(self, data_conf=None):
        ...
        dataset = get_dataset("image_folder")(data_conf)
...
if __name__ == "__main__":
    ...
    default_conf = OmegaConf.create(CustomPipeline.default_conf)
